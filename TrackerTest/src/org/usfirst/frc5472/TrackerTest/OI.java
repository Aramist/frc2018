...
import org.usfirst.frc5472.TrackerTest.commands.ShiftGearCommandDisable;
import org.usfirst.frc5472.TrackerTest.commands.ShiftGearCommandEnable;
...
public class OI {
	...
	public OI() {
		...
		shiftGearButton.whileHeld(new ShiftGearCommandEnable());
		shiftGearButton.whenReleased(new ShiftGearCommandDisable());
